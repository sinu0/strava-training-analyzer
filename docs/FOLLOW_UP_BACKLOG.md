...
| GitHub Actions | Zielony pipeline `34048848336` zgłasza, że akcje oparte na Node.js 20 są przymusowo uruchamiane na Node.js 24, a `actions/setup-java@v4` jest przestarzałe. Nie blokuje to obecnego wydania. | Na osobnym branchu zaktualizować oficjalne akcje CI do wspieranych głównych wersji i potwierdzić pełny pipeline quality/E2E/LAN. |
